...
import org.apache.http.HC4.auth.AuthSchemeProvider;
import org.apache.http.HC4.client.AuthenticationStrategy;
import org.apache.http.HC4.client.BackoffManager;
import org.apache.http.HC4.client.ConnectionBackoffStrategy;
import org.apache.http.HC4.client.RedirectStrategy;
import org.apache.http.HC4.client.ServiceUnavailableRetryStrategy;
import org.apache.http.HC4.client.config.AuthSchemes;
import org.apache.http.HC4.client.config.CookieSpecs;
import org.apache.http.HC4.client.config.RequestConfig;
import org.apache.http.HC4.client.entity.InputStreamFactory;
import org.apache.http.HC4.client.protocol.RequestAcceptEncoding;
import org.apache.http.HC4.client.protocol.RequestAddCookies;
import org.apache.http.HC4.client.protocol.RequestAuthCache;
import org.apache.http.HC4.client.protocol.RequestClientConnControl;
import org.apache.http.HC4.client.protocol.RequestDefaultHeaders;
import org.apache.http.HC4.client.protocol.RequestExpectContinue;
import org.apache.http.HC4.client.protocol.ResponseContentEncoding;
import org.apache.http.HC4.client.protocol.ResponseProcessCookies;
...
import org.apache.http.HC4.config.SocketConfig;
import org.apache.http.HC4.conn.HttpClientConnectionManager;
import org.apache.http.HC4.conn.SchemePortResolver;
import org.apache.http.HC4.conn.socket.ConnectionSocketFactory;
import org.apache.http.HC4.conn.socket.LayeredConnectionSocketFactory;
import org.apache.http.HC4.conn.socket.PlainConnectionSocketFactory;
import org.apache.http.HC4.conn.ssl.DefaultHostnameVerifier;
import org.apache.http.HC4.conn.ssl.SSLConnectionSocketFactory;
import org.apache.http.HC4.conn.ssl.SSLContexts;
import org.apache.http.HC4.conn.util.PublicSuffixMatcher;
import org.apache.http.HC4.conn.util.PublicSuffixMatcherLoader;
import org.apache.http.HC4.cookie.CookieSpecProvider;
import org.apache.http.HC4.impl.auth.NTLMSchemeFactory;
import org.apache.http.HC4.impl.conn.DefaultProxyRoutePlanner;
import org.apache.http.HC4.impl.conn.DefaultRoutePlanner;
import org.apache.http.HC4.impl.conn.DefaultSchemePortResolver;
import org.apache.http.HC4.impl.conn.PoolingHttpClientConnectionManager;
import org.apache.http.HC4.impl.conn.SystemDefaultRoutePlanner;
import org.apache.http.HC4.impl.cookie.DefaultCookieSpecProvider;
import org.apache.http.HC4.impl.cookie.IgnoreSpecProvider;
import org.apache.http.HC4.impl.cookie.NetscapeDraftSpecProvider;
import org.apache.http.HC4.impl.cookie.RFC2965SpecProvider;
import org.apache.http.HC4.impl.execchain.BackoffStrategyExec;
import org.apache.http.HC4.impl.execchain.ClientExecChain;
import org.apache.http.HC4.impl.execchain.MainClientExec;
import org.apache.http.HC4.impl.execchain.ProtocolExec;
import org.apache.http.HC4.impl.execchain.RedirectExec;
import org.apache.http.HC4.impl.execchain.RetryExec;
import org.apache.http.HC4.impl.execchain.ServiceUnavailableRetryExec;
import org.apache.http.HC4.protocol.HttpProcessorBuilder;
import org.apache.http.HC4.protocol.ImmutableHttpProcessor;
import org.apache.http.HC4.util.TextUtils;
import org.apache.http.HC4.client.CookieStore;
import org.apache.http.HC4.client.CredentialsProvider;
import org.apache.http.HC4.client.HttpRequestRetryHandler;
import org.apache.http.HC4.client.UserTokenHandler;
import org.apache.http.HC4.conn.ConnectionKeepAliveStrategy;
import org.apache.http.HC4.conn.routing.HttpRoutePlanner;
import org.apache.http.HC4.conn.ssl.X509HostnameVerifier;
import org.apache.http.HC4.impl.DefaultConnectionReuseStrategy;
import org.apache.http.HC4.impl.NoConnectionReuseStrategy;
import org.apache.http.HC4.impl.auth.BasicSchemeFactory;
import org.apache.http.HC4.impl.auth.DigestSchemeFactory;
import org.apache.http.HC4.impl.client.BasicCookieStore;
import org.apache.http.HC4.impl.client.BasicCredentialsProvider;
import org.apache.http.HC4.impl.client.DefaultConnectionKeepAliveStrategy;
import org.apache.http.HC4.impl.client.DefaultHttpRequestRetryHandler;
import org.apache.http.HC4.impl.client.DefaultUserTokenHandler;
import org.apache.http.HC4.protocol.HttpProcessor;
import org.apache.http.HC4.protocol.HttpRequestExecutor;
import org.apache.http.HC4.protocol.RequestContent;
import org.apache.http.HC4.protocol.RequestTargetHost;
import org.apache.http.HC4.protocol.RequestUserAgent;
import org.apache.http.HC4.util.VersionInfo;
...
public class HttpClientBuilder {
     ...
     *   org.apache.http.HC4.conn.HttpClientConnectionManager)} and the {@link #setSSLSocketFactory(
     *   org.apache.http.HC4.conn.socket.LayeredConnectionSocketFactory)} methods.
     * </p>
     *
     *   @deprecated (4.4)
     */
     ...
     * with {@link org.apache.http.HC4.conn.util.PublicSuffixMatcherLoader}.
     *
     * @see org.apache.http.HC4.conn.util.PublicSuffixMatcher
     * @see org.apache.http.HC4.conn.util.PublicSuffixMatcherLoader
     *
     *   @since 4.4
     */
     ...
     * <p>
     * Please note this value can be overridden by the {@link #setConnectionManager(
     *   org.apache.http.HC4.conn.HttpClientConnectionManager)} method.
     * </p>
     */
...
`     */
    ...
    /**
     * Assigns a map of {@link org.apache.http.HC4.client.entity.InputStreamFactory}s
        ...
        if (authSchemeRegistryCopy == null) {
            authSchemeRegistryCopy = RegistryBuilder.<AuthSchemeProvider>create()
                ...
                .register(AuthSchemes.NTLM, new NTLMSchemeFactory())
                 //FIXME:since javax.* is not supported on Android
